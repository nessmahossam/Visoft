...
class ChatMileStone extends StatefulWidget {
  ...
  @override
  _ChatMileStoneState createState() => _ChatMileStoneState();
}

class _ChatMileStoneState extends State<ChatMileStone> {
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(10),
                            color: Colors.red),
                        child: Center(child: Text('Refuse')),
                      )
                    ],
                  )
                ],
